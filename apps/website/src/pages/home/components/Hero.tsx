  ...
  return (
    <section className="px-8 py-6">
      <div className="flex items-center gap-3 mb-6">
        <h2 className="text-2xl font-display font-bold">Welcome to Lycine</h2>
      ...
      <div className="relative w-full rounded-[2.5rem] overflow-hidden bg-tickify-card border border-white/5 p-12 md:p-20">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          >
            ...
            the{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-tickify-pink to-tickify-purple">
              Digital Cosmos
            </span>
          </motion.h1>
          ...
          >
            Book tickets, discover new films, connect with fellow movie lovers,
            and earn cosmic rewards with every visit to the digital realm.
          </motion.p>
