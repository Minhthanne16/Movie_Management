...
function FormInput({
  ...
  const colorMap = {
    ...
    purple:
      "focus:border-tickify-purple/50 focus:ring-tickify-purple/20 group-focus-within:text-tickify-purple",
  };
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="relative group">
        <Icon
          className={`absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 ${colorMap[accentColor].split(" ").pop()} transition-colors`}
          size={18}
        />
        <input
          {...registration}
      ...
      <AnimatePresence>
        {error && (
          <motion.p
            ...
            exit={{ opacity: 0 }}
            className="text-red-400 text-[10px] font-semibold mt-0.5 ml-1 flex items-center gap-1"
          >
...
export default function AuthPage() {
  ...
  const onRegister = (d: any) => {
    console.log("Register:", d);
    switchState("login");
  };
  const onSendOtp = (d: any) => {
    console.log("OTP sent to:", d.email);
    setForgotStep(2);
  };
  const onResetPw = (d: any) => {
    console.log("Reset:", otp.join(""), d);
    switchState("login");
  };
  ...
  const titles: Record<AuthState, { heading: string; sub: string; icon: any }> =
    {
      login: {
        ...
        sub: "Đăng nhập để quản lý hệ thống Lycine",
        icon: Sparkles,
      },
      register: {
        heading: "Tạo tài khoản",
        sub: "Đăng ký tài khoản quản trị viên Lycine",
        icon: User,
      },
      forgot: {
        heading: forgotStep === 1 ? "Quên mật khẩu?" : "Kiểm tra email",
        sub:
          forgotStep === 1
            ? "Nhập Gmail để nhận mã xác thực OTP"
            : "Chúng tôi đã gửi mã bảo mật đến hộp thư của bạn",
        icon: forgotStep === 1 ? KeyRound : CheckCircle2,
      },
    };
      ...
      >
        ...
        <div className="relative bg-slate-950/80 backdrop-blur-2xl border border-white/[0.08] rounded-3xl p-8 md:p-10 shadow-2xl shadow-black/40">
          ...
          <div className="text-center mb-2">
            <span className="text-xs font-bold tracking-[0.4em] uppercase bg-gradient-to-r from-tickify-pink to-tickify-purple bg-clip-text text-transparent">
              Lycine Admin
            </span>
          </div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <h1 className="text-3xl font-display font-bold bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent mb-1.5">
                  {t.heading}
                </h1>
                ...
                >
                  ...
                  <div className="flex justify-end">
                    <button
                      ...
                      className="text-[11px] font-semibold text-tickify-pink hover:text-tickify-pink/80 hover:underline transition-colors"
                    >
                      Quên mật khẩu?
                    </button>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-tickify-pink to-tickify-purple hover:opacity-90 text-white py-3.5 rounded-xl font-bold text-sm transition-all shadow-[0_0_24px_rgba(255,0,128,0.25)] hover:shadow-[0_0_32px_rgba(255,0,128,0.4)] flex items-center justify-center gap-2 group"
                  >
                    Đăng nhập
                    <ArrowRight
                      size={18}
              ...
              {authState === "register" && (
                ...
                >
                  <FormInput
                    ...
                    error={
                      registerForm.formState.errors.fullName?.message as string
                    }
                  />
                  <FormInput
                    icon={Mail}
                  ...
                  <FormInput
                    ...
                    registration={registerForm.register("confirmPassword", {
                      ...
                      validate: (v: string) =>
                        v === regPassword || "Mật khẩu không khớp",
                    })}
                    error={
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-tickify-cyan to-tickify-purple hover:opacity-90 text-white py-3.5 rounded-xl font-bold text-sm transition-all shadow-[0_0_24px_rgba(0,210,255,0.2)] hover:shadow-[0_0_32px_rgba(0,210,255,0.35)] flex items-center justify-center gap-2 group mt-2"
                  >
                    Đăng ký
                    <ArrowRight
                      size={18}
                  ...
                  <p className="text-center text-sm text-gray-500 pt-1">
                    ...
                    <button
                      ...
                      className="text-tickify-pink font-bold hover:underline"
                    >
                      Đăng nhập
                    </button>
                  </p>
              ...
              {authState === "forgot" && forgotStep === 1 && (
                <form
                  onSubmit={forgotForm.handleSubmit(onSendOtp)}
                  className="space-y-5"
                >
                  <FormInput
                    icon={Mail}
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-tickify-pink to-tickify-purple hover:opacity-90 text-white py-3.5 rounded-xl font-bold text-sm transition-all shadow-[0_0_24px_rgba(255,0,128,0.25)] flex items-center justify-center gap-2 group"
                  >
                    Gửi mã OTP
                    <ArrowRight
                      size={18}
                  ...
                  <div className="text-center">
                    <button
                      type="button"
                      onClick={() => switchState("login")}
                      className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-white transition-colors font-semibold"
                    >
              ...
              {authState === "forgot" && forgotStep === 2 && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-3 text-center">
                    <label className="text-[11px] font-bold text-gray-400 uppercase tracking-[0.25em]">
                      Nhập mã OTP 6 số
                    </label>
                  ...
                  <form
                    onSubmit={forgotForm.handleSubmit(onResetPw)}
                    className="space-y-4"
                  >
                    <FormInput
                      icon={Lock}
                      ...
                      placeholder="••••••••"
                      accentColor="pink"
                      registration={forgotForm.register("password", {
                        required: "Vui lòng nhập mật khẩu mới",
                        minLength: { value: 6, message: "Tối thiểu 6 ký tự" },
                      })}
                      error={
                        forgotForm.formState.errors.password?.message as string
                      }
                    />
                    <FormInput
                      icon={ShieldCheck}
                      ...
                      registration={forgotForm.register("confirmPassword", {
                        required: "Vui lòng xác nhận mật khẩu",
                        validate: (v: string) =>
                          v === forgotPassword || "Mật khẩu không khớp",
                      })}
                      error={
                    ...
                    <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-tickify-pink to-tickify-purple hover:opacity-90 text-white py-3.5 rounded-xl font-bold text-sm transition-all shadow-[0_0_24px_rgba(255,0,128,0.25)] flex items-center justify-center gap-2 group mt-1"
                    >
                      Đặt lại mật khẩu
                      <ShieldCheck
                        size={18}
